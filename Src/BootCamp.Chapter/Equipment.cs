...
namespace BootCamp.Chapter
{
    ...
    public class Equipment
    {
        ...
        {
            return (_weapon.GetWeight() + _gloves.GetWeight() + _chest.GetWeight() + _head.GetWeight() + _leftArm.GetWeight() + _leftShoulder.GetWeight() + _legs.GetWeight() + _rightArm.GetWeight() + _rightShoulder.GetWeight());
        }
